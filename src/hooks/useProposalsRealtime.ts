 ...
 *
 * Shares the same underlying Supabase channel as useHomeRealtime and
 * useChatListRealtime (see notificationChannel.ts) — no duplicate connections.
 */
import { useEffect, useRef } from 'react';
import { subscribeToNotification } from '../lib/notificationChannel';

export function useProposalsRealtime(userId: string, onStale: () => void): void {
